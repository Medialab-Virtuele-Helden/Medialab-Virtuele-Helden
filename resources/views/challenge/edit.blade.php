          ...
          <div class="mt-3">
            ...
            <div class="o-card-create-challenge">
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="challenge-title" name="title" value='{{$challenge->title}}'>
                </div>
              </div>
              <div class="row mb-3">
                <label for="challenge-description" class="col-sm-2 col-form-label">Content</label>
                <div class="col-sm-10">
                  <textarea class="text-editor form-control" id="challenge-content" name="content">{{$challenge->content}}</textarea>
                </div>
              </div>
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-auto">
                  <input type="datetime-local" class="form-control" id="challenge-start-date" name="start-date" value='{{$challenge->start_date}}'>
                </div>
              </div>
              <div class="row mb-3">
                <label for="challenge-end-date" class="col-sm-2 col-form-label">Einddatum</label>
                <div class="col-sm-auto">
                  <input type="datetime-local" class="form-control" id="challenge-end-date" name="end-date" value='{{$challenge->end_date}}'>
                </div>
              </div>
              <div class="row mb-0">
                <label for="challenge-title" class="col-sm-2 col-form-label">Goal aantal</label>
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="challenge-goal" name="challenge-goal" value='{{$challenge->challenge_goal}}'>
                </div>
              </div>
            </div>
          </div>
          <div class="">
            ...
            <div class="o-card-create-challenge">
              <div class="row mb-0">
                <label for="challenge-title" class="col-sm-2 col-form-label">Titel</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="challenge-reward" name="reward" value='{{$challenge->reward}}'>
                </div>
              </div>
            </div>
          </div>
